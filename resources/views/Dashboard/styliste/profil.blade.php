  ...
  <div class="row">
    ...
    @foreach ($stylistes as $styliste)
            <tr>
              ...
              <td>{{ $styliste->photo }}r</td>
              <td><a href="/update-styliste/{{ $styliste->id }}" class="btn btn-info">Update</a>
                <a href="/delete-etudiant/{{ $styliste->id }}" class="btn btn-danger">Delete</a></td>
            </tr>
