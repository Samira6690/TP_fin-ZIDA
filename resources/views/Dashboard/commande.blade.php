  ...
  <div class="row">
    ...
    @foreach ($commandes as $commande)
            <tr>
              ...
              <td>{{ $commande->styliste_id }}</td>
              <td>{{ $commande->user_id }}</td>
              <td><a href="/update-commande/{{ $commande->id }}" class="btn btn-info">Update</a>
                <a href="/delete-commande/{{ $commande->id }}" class="btn btn-danger">Delete</a></td>
            </tr>
