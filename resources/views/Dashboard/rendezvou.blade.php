...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Prouits</h2>
      <hr>
      <a href="/ajouter" class="btn btn-primary">Fixer un rendez vous</a>
      <hr>
      @if (session('status'))
    ...
    @foreach ($rendezvous as $rendezvou)
            <tr>
              ...
              <td>{{ $rendezvou->styliste_id }}</td>
              <td>{{ $rendezvou->user_id }}</td>
              <td><a href="/update-catégorie/{{ $rendezvou->id }}" class="btn btn-info">Update</a>
                <a href="/delete-catégorie/{{ $rendezvou->id }}" class="btn btn-danger">Delete</a></td>
            </tr>
