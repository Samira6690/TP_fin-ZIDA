...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Prouits</h2>
      <hr>
      <a href="/ajouter" class="btn btn-primary">Ajouter une catégorie</a>
      <hr>
      @if (session('status'))
    ...
    @foreach ($catégories as $catégorie)
            <tr>
                <td>{{ $id }}</td>
              <td>{{ $catégorie->nom }}</td>
              <td><a href="/update-catégorie/{{ $catégorie->id }}" class="btn btn-info">Update</a>
                <a href="/delete-catégorie/{{ $catégorie->id }}" class="btn btn-danger">Delete</a></td>
            </tr>
