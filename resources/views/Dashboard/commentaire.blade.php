...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Styliste House</a>
...
<div class="container-fluid">
  <div class="row">
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="#">
                <svg class="bi"><use xlink:href="{{ asset('')" }}</svg>
        Styliste
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{ asset('') }}">
                <svg class="bi"><use xlink:href="{{ asset('')}}"</svg>
                Commandes
              </a>
            </li>
    ...
    @foreach ($commentaires as $commentaire)
            <tr>
                <td>{{ $id }}</td>
              <td>{{ $commentaire->date_commande}}</td>
              <td>{{ $commentaire->montant}}</td>
              <td>{{ $commentaire->commande_id }}</td>
            <td>{{ $commentaire->styliste_id}}</td>
              <td>{{ $commentaire->user_id }}</td>
              <td><a href="/update-commentaire/{{ $commentaire->id }}" class="btn btn-info">Update</a>
                <a href="/delete-commentaire/{{ $commentaire->id }}" class="btn btn-danger">Delete</a></td>
            </tr>
