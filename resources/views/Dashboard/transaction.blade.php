  ...
  <div class="row">
          ...
          <thead>
            ...
            <tr>
              ...
              <th scope="col">Montant</th>
               <th scope="col">date_transaction</th>
    ...
    @foreach ($transactions as $transaction)
            <tr>
              ...
              <td><a href="/update-transaction/{{ $transaction->id }}" class="btn btn-info">Update</a>
                <a href="/delete-transactions/{{ $transaction->id }}" class="btn btn-danger">Delete</a></td>
            </tr>
